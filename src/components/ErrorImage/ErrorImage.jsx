...
/**
 * Компонент для отображения изображения-заглушки при ошибках загрузки
 * изображений (коды ответов 4xx и 5xx)
 *
 ...
 * @param {string} props.imageClassName - CSS-класс для самого
 *   изображения-заглушки
 * @returns {JSX.Element | null} - Компонент изображения-заглушки или null, если
 *   show=false
 */
