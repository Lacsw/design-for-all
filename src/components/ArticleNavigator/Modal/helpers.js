...
/**
 * Для многих параметров колеса получаем значения через интерполяцию.\
...
export class WheelConfig {
  ...
  // Если не парится насчет увеличения, то эталлонная величина периода = 2.
  // Эталонная, т.к. при смещение на 0.5 от центра -> масштаб будет = 0.
