...
export class WheelConfig {
  ...
  // Устарело. Т.к. теперь необходимые значения для параметров назначаются, исходя
  // из количества шагов, на которые слайд удален от центра. Так что для любого кол-ва слайдов подойдет
  // одно значение
